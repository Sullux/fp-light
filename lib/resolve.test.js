...
describe('resolve', () => {
  ...
  // test.only('should deep await in a pipe', async () => {
  //   const getConfig = ({ state, county }) => {
  //     console.log(state, county)
  //     return Promise.resolve(42)
  //   }
  //   const getConfigs = pipe(
  //     _.address,
  //     { state: _.state, county: _.county },
  //     getConfig, // NEVER gets awaited properly and pipe just moves on
  //     tap(console.log),
  //     // or(_, defaultConfig),
  //   )
  //   const result = await getConfigs({ address: { state: 'WA', county: 'KING' } })
  //   console.log('???', result)
  // })

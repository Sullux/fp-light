import { awaitAll, isAsync, override, trace } from './'
...
export const spreadableSymbol = '@@spread'
...
const identityProxy = {
  ...
  ownKeys: (target) => ([...Reflect.ownKeys(target), spreadableSymbol, Symbol.iterator]),
}
...
// todo: make this work more like curry

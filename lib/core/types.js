const { isString, Null, Undefined } = require('./helpers')
...
const Any = Spreadable(function Any () { return Any })
Object.defineProperty(Any, Symbol.hasInstance, {
  value: () => true,
})

const None = Spreadable(function None () { return None })
...
const Primitive = Spreadable(function Primitive () { return Primitive })

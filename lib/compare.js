...
export const is = curry(callable(function is (value, compareValue) {
...
export const compareTypes = curry(callable(
...
export const compare = curry(callable(
...
export const equal = curry(callable(function equal (value, compareValue) {

...
export const firstPassResolvable = (untraced) => {
...
examples: |
  ...
  ```
*/
export const is = firstPassResolvable(function is (value, compareValue) {
...
examples: |
  ...
  ```
*/
export const isExactType = firstPassResolvable(function isType (type, value) {
...
*/
export const isType = firstPassResolvable(function isType (type, value) {
...
description: |
  ...
  the above rules.
*/
export const compare = firstPassResolvable(
...
description: |
  ...
  deep equality.
*/
export const equal = firstPassResolvable(function equal (value, compareValue) {

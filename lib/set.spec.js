...
describe('set', () => {
  ...
  it('should set a value from object input', () =>
    deepStrictEqual(set({ foo: 42 })({ foo: 41 }), { foo: 42 }))
  it('should set multiple values from object input', () =>
    deepStrictEqual(
      set({ foo: 42, 'bar.0': 'baz' })({ foo: 41 }),
      { foo: 42, bar: ['baz'] }),
    )
})

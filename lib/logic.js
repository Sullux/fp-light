...
import { call, callable } from './call'
import { trace } from './trace'

export const not = callable(function not (predicate) { return !predicate })
export { not as falsy }
...
export const xor = callable(function xor (predicate1, predicate2) {
